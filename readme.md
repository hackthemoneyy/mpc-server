...
current version handles the core mpc functionality. production-ready for mvp.
...
- chain discovery (auto-detect balances)
- walletconnect integration
- mobile sdks

or keep it minimal. depends what you need.

## docs

- [quick start](QUICK_START.md) — 5min setup guide
...
**wasm errors?**
```bash
npm install @vultisig/sdk --force
```
...
mpc wallets are the future. no seed phrases, no single points of failure, threshold security \\w ux that doesn't suck.

vultisig sdk handles the hard crypto. this api makes it accessible via rest. build your wallet app on top, integrate \\w your platform, whatever.

feel free to fork, modify, ship. questions? issues? pr's welcome.

---

built \\w [vultisig sdk](https://vultisig.com) | see [architecture docs](ARCHITECTURE.md) for deep dive
